...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("USER", "ADMIN", "ORGANIZATION", name="role"),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("account", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_account_email"), ["email"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_account_username"), ["username"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_account_verification_code"),
            ["verification_code"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "gender", sa.Enum("MALE", "FEMALE", name="gender"), nullable=True
        ),
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "identity_picture", mysql.VARCHAR(length=255), nullable=True
        ),
        sa.Column(
            "identity_verification_status",
